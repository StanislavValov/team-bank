...
describe('Transaction module', function () {
    ...
    describe("bankService send request to", function () {
        ...
        beforeEach(inject(function ($httpBackend, $rootScope, $controller) {
            ...
            authRequestHandler = httpBackend.expectGET('/amount');
        ...
        it('"/bankService/deposit" for deposit amount', function () {
            ...
            httpBackend.expectPOST('/amount/deposit', {amount: 70}).respond({amount: 120});
        ...
        it('"/bankService should fail"', function () {
            httpBackend.expectPOST('/amount/deposit', {amount: 34}).respond(404, "Not found");
        ...
        it('"/bankService/withdraw" for withdraw amount', function () {
            ...
            httpBackend.expectPOST('/amount/withdraw', {amount: 60}).respond({amount: 30});
        ...
        it('"/bankService/withdraw" should withdraw more amount when we have', function () {
            ...
            httpBackend.expectPOST('/amount/withdraw', {amount: 60}).respond(400, "Not enough many in account");
